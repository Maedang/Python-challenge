...
with open(csvpath) as csvfile:
    ...
    for name in all_votes:
        # This will only happen when the name is not in the candidate name list and is not the current name that we compare. 
        if name!= new_name and name not in set(candidates_name_list): 
            ...
            # reset the new_name as current candidate name to find the new one once the loop repeats. 
